<html>
    ...
    <body>
        <nav class="navbar  navbar-expand-sm bg-hex navbar-dark">
                    ...
                    <table class="table" style="width:100%">
                        ...
                        if($row == 1){
                            ...
                            echo "<script>
                                ...
                                <tfoot>
                                <tr>
                                <td><img src='images/carteirinha2.png' width='300'heigth='auto' class='carteira' ></img></td>
